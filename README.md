...
* [Varpulis](https://github.com/varpulis/pySigma-backend-varpulis) - Open-source stream engine that runs Sigma rules, correlation rules included, on Kafka or NATS event streams, judged in event time

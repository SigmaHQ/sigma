...
3. Make your changes, and test them:
   ...
   3.3. **Sigma CLI validation** - runs schema and validation checks using [Sigma CLI](https://github.com/SigmaHQ/sigma-cli). Run this if you have `sigma` with `pySigma-validators-sigmaHQ` installed:

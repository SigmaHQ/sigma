    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fieldMappings = {       # mapping between Sigma and ATP field names
            ...
            "DeviceRegistryEvents": {
                ...
                "ParentProcessName": ("InitiatingProcessParentFileName", self.default_value_mapping),
                "RegistryKey": ("RegistryKey", self.default_value_mapping),
                "RegistryValue": ("RegistryValueName", self.default_value_mapping),
                "RegistryData": ("RegistryValueData", self.default_value_mapping),

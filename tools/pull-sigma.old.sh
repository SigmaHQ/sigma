...
echo " "
rule_counter=0
$ESALERT_HOME="/Users/i.motrenko/Project/sigma/rules"
# Windows rules
    ...
    if [ "$rule_category" == rules/windows/process_creation ]; then
        for rule in $rule_category/* ; do
            if [ $rule != rules/windows/process_creation/win_mal_adwind.yml ]; then
                if SIGMAremoveNearRules "$rule"; then
                    ...
                    ./sigmac -t elastalert -c tools/config/generic/sysmon.yml -c /Users/i.motrenko/Project/sigma/tools/config/wazuh.yml -o /Users/i.motrenko/Project/sigma/wazuh/rules/sigma_sysmon_$(basename $rule) "$rule"
                    ...
                    ./sigmac -t elastalert -c tools/config/generic/windows-audit.yml -c /Users/i.motrenko/Project/sigma/tools/config/wazuh.yml -o /Users/i.motrenko/Project/sigma/wazuh/rules/sigma_$(basename $rule) "$rule"
        ...
        for rule in $rule_category/* ; do
            if SIGMAremoveNearRules "$rule"; then
                ...
                ./sigmac -t elastalert -c /Users/i.motrenko/Project/sigma/tools/config/wazuh.yml -o /Users/i.motrenko/Project/sigma/wazuh/rules/sigma_$(basename $rule) $rule
                rule_counter=$[$rule_counter +1]
            fi
        done
    fi
...
for rule in rules/apt/* ; do
    if SIGMAremoveNearRules "$rule"; then
        ...
        ./sigmac -t elastalert -c tools/config/generic/sysmon.yml -c /Users/i.motrenko/Project/sigma/tools/config/wazuh.yml -o /Users/i.motrenko/Project/sigma/wazuh/rules/sigma_sysmon_apt_$(basename $rule) "$rule"
        # Give unique rule name for sysmon
        sed -i 's/^name: /name: Sysmon_/' /Users/i.motrenko/Project/sigma/rules/sigma_sysmon_apt_$(basename $rule)
        ./sigmac -t elastalert -c tools/config/generic/windows-audit.yml -c /Users/i.motrenko/Project/sigma/tools/config/wazuh.yml -o /Users/i.motrenko/Project/sigma/wazuh/rules/sigma_apt_$(basename $rule) "$rule"
        rule_counter=$[$rule_counter +1]
    fi
done
echo "-------------------------------------------------------"

...
The full updated list, can always be found [here](https://github.com/SigmaHQ/pySigma/blob/main/sigma/processing/transformations/__init__.py).

## References

- [Sigma Blog Post](https://blog.sigmahq.io/building-flexible-detections-with-sigma-placeholders-7c1b814e2860)
- [Sigma Specification - Placeholders](https://github.com/SigmaHQ/sigma-specification/blob/main/specification/sigma-rules-specification.md#placeholders)
